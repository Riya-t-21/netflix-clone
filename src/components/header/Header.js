    ...
    <header>
      ...
      <div className="header_content">
        <div className="header_billboard">
          <img
            src="https://images.moviesanywhere.com/929eb763ffea62aff97b3f48b74853f7/13e506be-c360-4363-aca8-d095e8f16582.png?r=2x1&w=300"
            alt="bilboard"
          />
        </div>
        <h4 className="header_des">
          "Two teenage cancer patients begin a life-affirming journey to visit a
          reclusive author in Amsterdam. Hazel and Augustus are two teenagers
          who share an acerbic wit, a disdain for the conventional, and a love
